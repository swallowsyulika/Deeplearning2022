...
gen_img_root = Path("task1/images")
weights_root = Path("task1/weights")
loss_root = Path("task1/loss")
...
dataloader = DataLoader(
    EMnistDataset(root_dir="../../lab4/EMNIST/ndy/emnist-byclass-train-images.npy",
